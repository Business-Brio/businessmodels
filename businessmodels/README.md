...
```
Extraction of Servisable Addressable Market(SAM) for a business unit/entity (DMU for DEA Models) by taking inputs for GIS cordinates for the specifics business unit's catchment area as received after running Voronoi Tessellation.
